...
function Temperature({data}) {
  return (
    <div className='h-60 w-60 p-4 '> 
        <div className="w-full h-10  border-2 border-gray-500 shadow-lg rounded-lg bg-blue-900 text-white">
          <h1 className='text-center pt-1 font-bold'>{data && data.map(item => item.location.name)}</h1>
        </div>
        <div className="w-full h-44 border-2 border-gray-500 bg-white shadow-lg rounded-lg pl-3">
